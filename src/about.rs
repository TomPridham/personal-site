...
pub fn about() -> Result<Markup, Box<dyn Error>> {
    let a = html! {
        ...
        p{
            "currently, i live in millcreek with my wife and three dogs. i spend most of my time playing around with rust, doing yardwork, playing video games or board games. i used to be really into climbing and biking and am trying to get back into them."
        }
    };
    Ok(a)
}
